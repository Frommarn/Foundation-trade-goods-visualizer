...
// let currentVisualization = "d3dag"; // Default visualization
...
//             processDataD3(results.data);
//             processDataD3DAG(results.data);
//         },
...
function handleFileSelect(event) {
    ...
    reader.onload = function (e) {
        try {
            ...
            // processDataD3(yamlData); // Pass YAML data to D3 processing
            // processDataD3DAG(yamlData); // Pass YAML data to D3DAG processing
...
function processDataD3DAG(data) {
    nodes = [];
    links = [];
    const nodeMap = new Map(); // Create a map to store nodes by ID
...
function updateVisualization() {
    ...
    //     drawTidyTree();
    // } else if (currentVisualization === "d3dag") {
    //     drawD3DAG();
    // }
    drawD3DAG();
}
